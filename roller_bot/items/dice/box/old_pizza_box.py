...
class OldPizzaBox(Box):
    ...
    def __init__(self) -> None:
        ...
        self.box_items = [
            ...
            BoxItem(
                    item_def_id=DailyStreakToken().id,
